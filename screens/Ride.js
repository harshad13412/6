...
export default class TransactionScreen extends React.Component {
  ...
  initiateCycleIssue = async () => {
   ...
   db.collection('Cycles').doc(this.state.scannedCycleId).update({
    ...
    db.collection('Students')
      ...
      .update({
        NumCyclesIssued: firebase.firestore.FieldValue.increment(1),
      });
  ...
  handleTransaction = async () => {
    ...
    if (!transactionType) {
      alert("The cycle doesn't exist in the database!");
      this.setState({
        scannedStudentId: '',
        scannedCycleId: '',
      });
      ...
      var isStudentEligible1 = await this.checkStudentEligibilityForReturn();
      if (isStudentEligible1) {
